def get_action_prompt(instruction='', summary_history=[], action_history=[], last_summary='', last_action='',
    ...
    if last_summary != '':
        ...
        prompt += f"You previously wanted to perform the operation \"{last_summary}\" and executed the Action \"{last_action}\". Do not repeat the \"inform\" and \"send QR code\" unless the reflect tells you that the previous action was wrong."
        prompt += "\n\n"
